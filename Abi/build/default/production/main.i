...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.05\pic\include\pic18f4550.h"
...
# 17 "lcd.h"
void LCD_init(void);
void msg2LCD(const unsigned char*);
...
long int dec, uni;
long int multi=0;
long int bajo=5, medio=10, alto=20, flag2=0, flag3=0, flag4=0;
long int flag5=0, flag6=0, flag7=0;


long int a=5, b=5, c=15, flag=0, fb=0, fa=0;
long int cuatro=0;

long int flagdes=0, contdes_a=10;
long int flag_siete=0, cont_siete=10;


long int bajo3=5, medio3=10, alto3=20, t1=0, t2=0, t3=0;

long int cent=3,y1=0;


long int flagbajo=0, seisbajo=5,flagmedio=0, seismedio=10, flagalto=0, seisalto=20, dec, uni;
void pesobajoetapa6(void);
void pesomedioetapa6(void);
void pesoaltoetapa6(void);
...
void pesobajo() {
if (kilos >= 5 && kilos < 10 && flag2 == 0 && tecla()==5) {
clear_LCD();
flag2 = 1;
LATCbits.LC0 = 1;
LATCbits.LC1 = 1;
